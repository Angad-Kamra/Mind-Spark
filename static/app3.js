...
var ia = {
  ...
  ja = {
    ma: "data:image/gif;base64,R0lGODlhswAFAIAAAAAAAP///yH5BAEAAAEALAAAAACzAAUAAAKRDB52kIrL3IOJRlNRfo3d2mGgs11L2Z2QF5oi5sZU1tR2qcGtHfN+7Rr5IkSe5wjqJXfLW1C3ZEGfL8Xt+lodNZ8sadOanITAb1XHSoe5a1PO20TD4+cuFjiG6oXSUDn+pFT0N9XXl8RBNhckpbb3YecEGSkzZmFpIZkokmfZZgjnabS5BYlnyhSYIor3YxVQAAA7"
  },
  ka = {
  ...
  la = {
    ma: "data:image/gif;base64,",
    Y: [{
      x: 1,
      y: 0,
      i: 8,
  ...
  ma = {
    ma: "data:image/gif;base64,R0lGODlhCQAIAJEAAJeXl////wAAAAAAACH5BAEAAAIALAAAAAAJAAgAAAIUhG8CwR3G0FNtTRqvslps5oWeUQAAOw==",
    Y: [{
      x: 0,
      y: 0,
      i: 9,
...
function ya() {
  let a = [
    ...
    b = z();
  return D(wa([sa(C(.3, function() {
    Math.random() < 5E3 / v.sampleRate && (b = z());
    return b
  }), 900), ta(C(.3, function(c) {
...
function Da() {
  function a(a) {
    let b = 0,
      c = [];
    do c.push([b, a ? 1 : .45]), a = !a, b += .1875, c.push([b - 1E-7, 0]); while (1 >= b);
    return c
  }
  let b = a(!0),
    c = a(!1),
...
function M(a, b, c) {
  let d = [];
  for (let e = 0; e < c; e++) a.forEach(([a, ...c]) => {
    d.push([a + b * e, ...c])
  });
  return d
}
...
function Ha(a) {
  let b = a / v.sampleRate,
    ...
    d = 0,
    e;
  return D(C(3, function() {
    e = Math.round((1 * y(c) + 1 * y(c / 2) + .1 * y(2 * c) + .001 * y(3 * c) + 1E-4 * y(4 * c)) / 2.111 * 5) / 5;
    c += b;
    d += 1 / v.sampleRate;
    1.25E-4 <= d && (c += z() * b * .6, d -= 1.25E-4);
    return e
  }), [
    [0, 0, .5],
    [.001, 1, .1],
...
function Ia(a, b) {
  ...
  var d = [0, .75, 1.5, 2, 2.75, 3.5, 4, 4.75, 5.5, 6, 6.75, 7.5];
  d = [...N(d, [4, 7, 11, 4, 7, 11, 12, 11, 4, 12, 11, 4]), ...P(N(d, [4, 7, 11, 4, 7, 11, 12, 11, 4, 12, 11, 4]), 8), ...P(N(d, [4, 5, 12, 4, 5, 12, 12, 11, 4, 12, 11, 4]), 16), ...P(N(d, [2, 7, 11, 2, 7, 11, 12, 11, 2, 12, 11, 2]), 24)];
  d.push([30.5, 14]);
  L(d, c, Ha, b);
  a.set(c, 0);
  a.set(c, c.length);
  ...
  constructor(a) {
    super({
      ...
      [1]: {
        N: (b) => {
          this.g = 0;
          let c = -.5 + Math.random() + (1 === b.I ? Math.PI : 0);
...
class pb {
  constructor(a, b) {
    ...
    this.g = 0;
    this.Qb = [{
      ua: new ob("#d48621", 18, 0),
      Fa: 0
    }, {
      ua: new ob("#fff2aa", 9, 8),
      Fa: .1
    }, {
      ua: new ob("#d48621", 9, 7),
      Fa: .2
    }, {
      ua: new ob("#fff2aa", 9, 6),
      Fa: .3
    }];
    m.Ja(1);
    Y(ab);
...
class Bb extends Z {
  ...
  f() {
    if (this.na)
      ...
      } else this.y > k.height + 100 ? this.ba() : ((this.J = this.F(this.x, this.y + 1) && !this.ja(this.x, this.y + 1, {
        qa: 2
      })) && this.xa.start(4), t[32] && !u[32] && this.da.start(4), t[32] || this.da.stop(), this.Oa.f(), this.ea.f(), 0 !== this.a && (this.I = E(this.a)), this.move(this.a * g, this.b * g), this.da.f(), this.xa.f(), this.xc(), this.m.f());
    else this.mb.f(), this.m.f()
  }
  xc() {
    this.K = 0;
    this.m.nc(E(this.a));
    4 === this.ea.w ? this.K = 0 === this.a ? 0 : 3 : this.J ? 100 < Math.abs(this.a) && (this.K = Math.floor(this.gb) % 2 + 1, this.gb += .1) : 100 < Math.abs(this.a) ? (this.K = 1, 100 < this.b && (this.K = 4)) : this.K = 100 < this.b ? 5 : 0;
    let a = 0 > this.b ? Math.min(.1, -this.b / 100) : 0;
    this.Ab = 1 - a;
    this.ab = 1 + 2 * a;
  ...
  Va() {
    let a = 160 * (-!!t[1] + !!t[4]),
      b = this.J ? 1 : .5;
    0 === a ? this.a = F(this.a, a, 800 * b * g) : 0 === this.a ? this.a = this.J ? .1 * a : F(this.a, a, 800 * b * g) : (0 < a ? 1 : 0 > a ? -1 : 0) === E(this.a) ? this.a = F(this.a, a, 800 * b * g) : (0 < a ? 1 : 0 > a ? -1 : 0) !== E(this.a) && (this.a = F(this.a, a, 3200 * b * g));
    !this.Na && this.xa.active && this.da.active && (this.b = -128, this.V = .4, this.da.stop(), Y($a));
    if (!this.J)
  ...
  move(a, b) {
    let c = (b) => {
        b.qa & 2 && .5 <= Math.abs(a) ? this.ba() : this.ec(b.a)
      },
      d = (a) => {
  ...
  get v() {
    return {
      ...
      width: this.$,
      height: this.ha,
      ta: this.x - this.Z + this.$ / 2,
      aa: this.y - this.sa + this.ha / 2
    }
  }
  get Na() {
    return 3 === this.Oa.w
  ...
  oc() {
    this.wa || (this.wa = !0, this.Ub = new vb, k.L(this.Ub), m.Ja(1), Y(bb, .2, !0))
  }
}
class Cb {
  constructor() {
...
class Hb {
  ...
  wc() {
    ...
    this.Ca = !this.Ca;
    this.Da += .75 * (this.Cb - this.Da);
    this.Ea += .75 * (this.Db - this.Ea);
...
class Kb extends Jb {
  ...
  c(a, b) {
    ...
    b.globalAlpha = 1 - a * (1 - a) * c * (1 - c) - .01 + .02 * Math.random();
    b.fillStyle = q;
...
class Mb extends Z {
  ...
  async U() {
    this.C = await J(this.width, this.height, (a) => {
      I(0, 0, this.width / 8 - 1, this.height / 8 - 1, (b, c) => {
        a.fillStyle = Ea(q, .94 - .01 + .02 * Math.random());
  ...
  f() {
    ...
    this.x += a;
    this.y += b;
    l.na && (c ? l.move(a, 0 > b || !l.tb ? b : 0) : G(l.v, this) && (a ? l.Ya(0 < a ? this.x + this.width - l.v.x : this.x - l.v.x - l.v.width, () => {
      l.ba()
    }) : b && l.Za(0 < b ? this.y + this.height - l.v.y : this.y - l.v.y - l.v.height, () => {
      l.ba()
    })));
    this.T = !0
  }
  ja(a, b) {
    return k.F(a, b, this.width, this.height, {
      Wa: this
    })
  }
  c() {
...
class Yb extends Z {
  ...
  c() {
    let a;
    if (.2 > this.S) a = 1 - this.S / .2;
    else if (14.8 < this.S) a = 1 - (15 - this.S) / .2;
    else return;
    let b = 1 * this.width,
      c = this.height * a,
